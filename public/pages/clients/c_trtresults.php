...
<!--HEAD-->
    <?php
    //if there is a value passed from a form input with a name of 'trt_search', do the following...
    if (isset($_POST['trt_search_all'])) {
        //set the variable 'trt_search' as the term input in the form
        ...
        if (isset($_POST['trt_search'])) {
            ...
            //this is the query which matches the term held in the trt_search variable
            //to any terms within the columns listed from the table 'businesses'
            $query = "
                SELECT *
                FROM treatments
                WHERE businesses_id = $_SESSION[b_id]
